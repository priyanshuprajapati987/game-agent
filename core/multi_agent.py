...
from .offline_ai import ModelConfig
...
class MultiAgentSpawner:
    ...
    def set_callbacks(self, on_agent_action: Optional[Callable] = None):
    ...
    def spawn_agent(
        ...
        with self._lock:
            ...
            agent.set_callbacks(on_action=self._handle_agent_action)

            self._agents[agent_id] = agent
            self._agent_info[agent_id] = AgentInfo(agent_id=agent_id, role=role)
